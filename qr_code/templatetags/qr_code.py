...
def qr_from_text(text, **kwargs):
    """Wrapper for function :func:`~qr_code.qrcode.make_qr_code`"""
    return _make_qr_code(text, qr_code_args=kwargs, embedded=True)


@register.simple_tag()
def qr_for_email(email, **kwargs):
    """Wrapper for function :func:`~qr_code.qrcode.maker.make_embedded_qr_code`"""
...
def qr_url_from_text(text, **kwargs):
    """Wrapper for function :func:`~qr_code.qrcode.serve.make_qr_code_url`"""
