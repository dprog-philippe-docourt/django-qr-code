...
class TestQRUrlFromDataResult(SimpleTestCase):
        ...
        for url_options in product([True, False, None], [True, False, None], users):
            ...
            if expected_status_code == 200:
                if is_first and REFRESH_REFERENCE_IMAGES:
                    write_svg_content_to_file(TestQRUrlFromDataResult.default_ref_base_file_name, image_data)
                    is_first = False
    ...
    def test_png_url(self):
        ...
        for url_options in product([True, False, None], [True, False, None]):
            ...
            if expected_status_code == 200:
                if is_first and REFRESH_REFERENCE_IMAGES:
                    write_png_content_to_file(TestQRUrlFromDataResult.default_ref_base_file_name, response.content)
                    is_first = False
    ...
    def test_svg_error_correction(self):
        ...
        for correction_level in ERROR_CORRECTION_DICT:
            ...
            url1 = make_qr_code_url(
                COMPLEX_TEST_TEXT_AS_UTF_8, QRCodeOptions(error_correction=correction_level), force_text=False, cache_enabled=False
            )
            ...
            url5 = qr_url_from_data(
                COMPLEX_TEST_TEXT_AS_UTF_8,
    ...
    def test_png_error_correction(self):
        ...
        for correction_level in ERROR_CORRECTION_DICT:
            ...
            url1 = make_qr_code_url(
                COMPLEX_TEST_TEXT_AS_UTF_8,
                QRCodeOptions(error_correction=correction_level, image_format="png"),
                force_text=False,
                cache_enabled=False,
            )
            ...
            url5 = qr_url_from_data(
                COMPLEX_TEST_TEXT_AS_UTF_8,
                options=QRCodeOptions(error_correction=correction_level, image_format="PNG"),
                cache_enabled=False,
            )
            url = url1
    ...
    def test_png_eci(self):
        ...
        for eci in [False, True]:
            ...
            url1 = make_qr_code_url(
                COMPLEX_TEST_TEXT_AS_UTF_8, QRCodeOptions(eci=eci, image_format="png"), force_text=False, cache_enabled=False
            )
            url2 = make_qr_code_url(
                COMPLEX_TEST_TEXT_AS_UTF_8, QRCodeOptions(eci=eci, image_format="PNG"), force_text=False, cache_enabled=False
            )
    ...
    def test_svg_micro(self):
        ...
        for micro in [False, True]:
            ...
            url5 = qr_url_from_data(
                COMPLEX_TEST_TEXT_AS_ISO_8859_1, options=QRCodeOptions(micro=micro, image_format="SVG"), cache_enabled=False
            )
            # Using an invalid image format should fallback to SVG.
    ...
    def test_png_micro(self):
        ...
        for micro in [False, True]:
            ...
            url1 = make_qr_code_url(
                COMPLEX_TEST_TEXT_AS_ISO_8859_1, QRCodeOptions(micro=micro, image_format="png"), force_text=False, cache_enabled=False
            )
            url2 = make_qr_code_url(
                COMPLEX_TEST_TEXT_AS_ISO_8859_1, QRCodeOptions(micro=micro, image_format="PNG"), force_text=False, cache_enabled=False
            )
            ...
            url5 = qr_url_from_data(
                COMPLEX_TEST_TEXT_AS_ISO_8859_1, options=QRCodeOptions(micro=micro, image_format="PNG"), cache_enabled=False
            )
            url = url1
            urls = get_urls_without_token_for_comparison(url1, url2, url3, url4, url5)
            self.assertEqual(urls[0], urls[1])
    ...
    def test_svg_boost_error(self):
        ...
        for boost_error in [False, True]:
            ...
            url1 = make_qr_code_url(
                COMPLEX_TEST_TEXT_AS_UTF_8, QRCodeOptions(boost_error=boost_error), force_text=False, cache_enabled=False
            )
            ...
            url5 = qr_url_from_data(
                COMPLEX_TEST_TEXT_AS_UTF_8, options=QRCodeOptions(boost_error=boost_error, image_format="SVG"), cache_enabled=False
            )
            # Using an invalid image format should fallback to SVG.
            url6 = qr_url_from_data(
                COMPLEX_TEST_TEXT_AS_UTF_8, boost_error=boost_error, image_format="invalid-format-name", cache_enabled=False
            )
            url = url1
            urls = get_urls_without_token_for_comparison(url1, url2, url3, url4, url5, url6)
            self.assertEqual(urls[0], urls[1])
    ...
    def test_png_boost_error(self):
        ...
        for boost_error in [False, True]:
            ...
            url1 = make_qr_code_url(
                COMPLEX_TEST_TEXT_AS_UTF_8,
                QRCodeOptions(boost_error=boost_error, image_format="png"),
                force_text=False,
                cache_enabled=False,
            )
            url2 = make_qr_code_url(
            ...
            url5 = qr_url_from_data(
                COMPLEX_TEST_TEXT_AS_UTF_8, options=QRCodeOptions(boost_error=boost_error, image_format="PNG"), cache_enabled=False
            )
            url = url1
            urls = get_urls_without_token_for_comparison(url1, url2, url3, url4, url5)
            self.assertEqual(urls[0], urls[1])
    ...
    def test_svg_encoding(self):
        ...
        for encoding in ["utf-8", "iso-8859-1"]:
            ...
            url1 = make_qr_code_url(
                COMPLEX_TEST_TEXT.encode(encoding), QRCodeOptions(encoding=encoding), force_text=False, cache_enabled=False
            )
            ...
            url5 = qr_url_from_data(
                COMPLEX_TEST_TEXT.encode(encoding), options=QRCodeOptions(encoding=encoding, image_format="SVG"), cache_enabled=False
            )
            # Using an invalid image format should fallback to SVG.
            url6 = qr_url_from_data(
                COMPLEX_TEST_TEXT.encode(encoding), encoding=encoding, image_format="invalid-format-name", cache_enabled=False
            )
            url = url1
            urls = get_urls_without_token_for_comparison(url1, url2, url3, url4, url5, url6)
            self.assertEqual(urls[0], urls[1])
    ...
    def test_png_encoding(self):
        ...
        for encoding in ["utf-8", "iso-8859-1"]:
            ...
            url1 = make_qr_code_url(
                COMPLEX_TEST_TEXT.encode(encoding),
                QRCodeOptions(encoding=encoding, image_format="png"),
                force_text=False,
                cache_enabled=False,
            )
            url2 = make_qr_code_url(
            ...
            url5 = qr_url_from_data(
                COMPLEX_TEST_TEXT.encode(encoding), options=QRCodeOptions(encoding=encoding, image_format="PNG"), cache_enabled=False
            )
            url = url1
            urls = get_urls_without_token_for_comparison(url1, url2, url3, url4, url5)
            self.assertEqual(urls[0], urls[1])
...
class TestQRFromDataSvgResult(SimpleTestCase):
    ...
    def test_micro(self):
        ...
        for micro in [False, True]:
            ...
            tests_data.append(
                dict(
                    source=f'{{% qr_from_data data image_format="svg" micro={micro} encoding=None %}}', ref_file_name=ref_file_name.lower()
                )
            )
            tests_data.append(
                dict(
                    source=f'{{% qr_from_data data image_format="svg" micro={micro} encoding="utf-8" %}}',
                    ref_file_name=ref_file_name.lower(),
                )
            )
    ...
    def test_encoding(self):
        ...
        for encoding in ["utf-8", "iso-8859-1"]:
            ...
            tests_data.append(
                dict(
                    encoding=encoding,
                    source=f'{{% qr_from_data data image_format="svg" encoding="{encoding}" %}}',
                    ref_file_name=ref_file_name.lower(),
                )
            )
    ...
    def test_mode(self):
        ...
        data_for_mode = [
            ...
            "義務教育諸学校教科用図書検定基準".encode("cp932"),
            "ウェブサイトにおける文字コードの割合、UTF-8が90％超え。Shift_JISやEUC-JPは？".encode("shift-jis"),
        ]
    ...
    def test_encoding(self):
        ...
        for encoding in ["utf-8", "iso-8859-1"]:
            ...
            tests_data.append(
                dict(
                    encoding=encoding,
                    source=f'{{% qr_from_data data image_format="png" encoding="{encoding}" %}}',
                    ref_file_name=ref_file_name.lower(),
                )
            )
